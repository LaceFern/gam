...
#define STEPS 409600
long ITERATION = STEPS;//204800
long ITERATION_warmup = STEPS;
    ...
    /******** MY CODE STARTS ********/
      switch (request_rw) {
        case 0:{
          ...
          // agent_stats_inst.add_starting_point_4debug();
          // agent_stats_inst.add_starting_point_4at();
          alloc->RLock(userop_stats_inst, to_access, item_size);
          // agent_stats_inst.add_ending_point_4at("request node: wake up -> RLock returns");
          // agent_stats_inst.add_ending_point_4debug("request node: call RLock -> RLock returns");

          // agent_stats_inst.add_starting_point_4debug();
          memset(buf, 0, item_size);
          // agent_stats_inst.add_ending_point_4debug("request node: call memset -> memset returns");

          // agent_stats_inst.add_starting_point_4debug();
          // agent_stats_inst.add_starting_point_4at();
          ret = alloc->Read(to_access, buf, item_size);
          // agent_stats_inst.add_ending_point_4at("request node: call Read -> Read returns");
          // agent_stats_inst.add_ending_point_4debug("request node: call Read -> Read returns");

          // agent_stats_inst.add_starting_point_4debug();
          // agent_stats_inst.add_starting_point_4at();
          alloc->UnLock(to_access, item_size);
          // agent_stats_inst.add_ending_point_4at("request node: call UnLock -> UnLock returns");
          // agent_stats_inst.add_ending_point_4debug("request node: call UnLock -> UnLock returns");
        ...
        case 1:{
          ...
          // agent_stats_inst.add_starting_point_4at();
          alloc->WLock(userop_stats_inst, to_access, item_size);
          // agent_stats_inst.add_ending_point_4at("request node: wake up -> WLock returns");

          memset(buf, i, item_size);

          // agent_stats_inst.add_starting_point_4at();
          ret = alloc->Write(to_access, buf, item_size);
          // agent_stats_inst.add_ending_point_4at("request node: call Write -> Write returns");
        ...
        case 2:{
          ...
          // agent_stats_inst.add_ending_point_4at("request node: wake up -> Read returns");
          read_access++;
          break;}
