...
class agent_stats{
  private:
    ...
    vector<std::chrono::time_point<std::chrono::system_clock>> starting_point_4_debug_q;
    vector<std::chrono::time_point<std::chrono::system_clock>> ending_point_4_debug_q;
    vector<string> time_tag_4_debug_q;
  ...
  public:
    ...
    void add_starting_point_4debug_q(GAddr gaddr, std::chrono::time_point<std::chrono::system_clock> point){
      if(start_flag){
        starting_point_4_debug_q.push_back(point);
      }
    }
    void add_ending_point_4debug_q(GAddr gaddr, std::chrono::time_point<std::chrono::system_clock> point, const string& tag){
      if(start_flag){
        ending_point_4_debug_q.push_back(point);
        time_tag_4_debug_q.emplace_back(tag);
      }
    }
    ...
    void print_agent_stats(){
      ...
      print_stats(time_tag_4_debug_q, starting_point_4_debug_q, ending_point_4_debug_q);
